...
const CURRICULUM = {
  '2': {
    ...
    // ─── MONTESSORI (parent-provided Grade 1 Montessori topic list; used as Grade 2 app's Montessori tab) ──────
    montessori: {
      math:      `Grade 1-2 Montessori Mathematics (from parent-provided topic list). Topics covered: Fractions (intro, parts, whole to tenths); Stamp Game (static division, dynamic division, remainder); Place Value; Multiples; Length; Greater Than, Less Than, Equal To; Rounding; Angles and its Parts; Multiplication (intro, static, multiplication board); Standard and Expanded Notation; Patterning; Reviewing Shapes; Unit Division Board; Division Board; Word Problems and Problem Solving; Making Change; Estimating Money; Understanding Money (Canadian coins and dollar bills); Skip Counting (using long bead chains, short bead chains, skip counting by 2s/5s/10s); Memorization Charts; Large Bead Frame Operations; Positive Snake Games; Geometric Cabinet; Constructive Triangles; Making Open and Closed Figures; Horizontal/Vertical/Oblique Lines; Straight and Curved Lines; Building the Decanomial; Memorizing Addition Facts; Essential combinations on Addition Strip Board; Finding Sums on the Addition Strip Board. Style: Montessori-informed — hands-on manipulative style (even in multiple-choice form), concrete-to-abstract reasoning, Canadian context (dollars $, cents). Each question picks ONE specific topic from the list and tests it at a 6-7-year-old level.`,
      language:  `Grade 1-2 Montessori Language Arts (from parent-provided topic list). Topics covered:
        PHONICS & READING: Short vowels (a, i, o, u); Consonant-Vowel-Consonant words; Consonant blends (front): bl/gl/spl/tw/qu, scr/spr/str, tr/pr/gr, cr/dr/fr, sk/sm/br, sn/sc/sw, sl/st/sp; Consonant blends (end): lc/mp/ct, lk/lf/ld, nd/nt/lt, st/sk/sp; Double consonants at end (ff, ss, ll); Magic syllables with silent e (a-e, e-e, i-e, o-e, u-e); r-controlled syllables (ar, er, ir, or, ur); Vowel digraphs; Sight words.
        GRAMMAR (Montessori Grammar Boxes & Charts 1A/1B/1C): Noun (common, proper, singular/plural, feminine/masculine/gender); Article (classification); Verb; Adjective; Verb Grammar Box; Adjective Grammar Box; Noun and Article Grammar Box; Introductory Chart.
        WORD STUDY: Alphabetical order; Synonyms; Antonyms; Rhyming Words; Compound Words; Root Words; Prefix; Suffix; Spelling ING words.
        PUNCTUATION: Period (full stop); Question Mark (Montessori presentation for both); General punctuation rules.
        WRITING: Picture Composition; Creative Writing; Identifying Sentences and Phrases; Abbreviating.
        HANDWRITING: Alphabet capital case (A-Z); Alphabet small case (a-z); Cursive writing (upper case & lower case).
        Each question picks ONE specific topic from the list and tests it at a 6-7-year-old reading level. Use authentic Canadian English spellings (colour, favour, etc.).`,
      geometry:  `Grade 1-2 Montessori Geometry (from parent-provided topic list). Topics covered: Introduction to the Montessori Protractor; The Angle and its Parts; The Story of Geometry; Bodies occupy Space; Geometric Solids (names: cube, sphere, cone, cylinder, rectangular prism, square pyramid, triangular prism, ovoid, ellipsoid); Constructive Triangle Box 1c; From the Solid to the Point (solid → surface → line → point hierarchy); The Line, The Ray, The Line Segment; Lines: Horizontal, Vertical, Oblique; The 'Plane' in Geometry; Polygons (triangle, quadrilateral, pentagon, hexagon, heptagon, octagon, nonagon, decagon); Point to a Solid; Ray, Line, and Segment (difference between each); Curved and Straight Lines. Style: Montessori-informed, concrete geometric vocabulary. Each question picks ONE specific topic and tests it at a 6-7-year-old level.`,
      geography: `Grade 1-2 Montessori Geography (from parent-provided topic list). Topics covered: Water and Landforms (lake, island, bay, peninsula, isthmus, strait, cape, gulf); Parts of the Volcano; Provinces of Canada (names, locations, capital cities of all 10 provinces + 3 territories); Parts of the Globe (north pole, south pole, equator, hemispheres); Oceans of the World (Pacific, Atlantic, Indian, Arctic, Southern); What is Air?; Water: Solid, Liquid and Gas; Identifying Continents (all 7); Parts of a Mountain (peak, slope, base, valley); Pin Maps of South America (countries, flags, capitals); The Continent of the Child (North America); Pin Maps of North America (countries, flags, capitals — Canada, USA, Mexico, etc.); Parts of the Flag; The Country of the Child (Canada); South America; Africa; North America; Coloured continent globe. Each question picks ONE specific topic and tests it at a 6-7-year-old level. Use Canadian place names and facts.`,
      biology:   `Grade 1-2 Montessori Biology (from parent-provided topic list). Topics covered: First Knowledge Cards (Botany and general); Parts of the Stem; Parts of a Guinea Pig; First Knowledge of the Animal Kingdom; Parts of a Plant (roots, stem, leaves, flower, fruit); Parts of an Insect — Butterfly (head, thorax, abdomen, wings, antennae, legs); Parts of a Fish (head, body, tail, fins, gills, scales); Wild Animals; Aquatic Animals; Basic differences between Plants and Animals; Distinguish between Living and Non-Living things. Style: Montessori nomenclature approach — label the parts, classify the kingdom. Each question picks ONE specific topic and tests it at a 6-7-year-old level. Be biologically accurate.`,
      history:   `Grade 1-2 Montessori History & Time (from parent-provided topic list). Topics covered: Reading the Numbers on the Clock; The Clock: O'Clock Time; The Clock: Half Past; The Clock: A Quarter Past; The Clock: A Quarter To; The Clock and its Parts (hour hand, minute hand, face); Months of the Year (Jan-Dec, order, seasons); Days of the Week (Mon-Sun, weekdays vs weekend); Roman Numerals I to X; Roman Numerals X to XX; Creation Stories (various cultures); The Fundamental Needs Chart (food, shelter, clothing, defence, transportation, communication, arts, spiritual); Timeline of Days. Each question picks ONE specific topic and tests it at a 6-7-year-old level. Be culturally respectful on creation stories — factual, not preferential.`,
      arts:      `Grade 1-2 Montessori Creative Expression (from parent-provided topic list). Topics covered: Warm and Cold Colours (warm: red, orange, yellow; cold: blue, green, purple); Colour Wheel — Primary colours (red, yellow, blue) and Secondary colours (orange, green, purple), and how primary colours mix to make secondary colours. Each question picks ONE topic and tests it at a 6-7-year-old level.`
    }
  },
  '5': {
    ontario: {
...
function buildQuestionPrompt({ subject, curriculum, level, recent }) {
  ...
  const recentList = (recent && recent.length)
    ...
    : '';
  const board = curriculum === 'ontario' ? 'Ontario (Canada)'
              : curriculum === 'cbse'    ? 'CBSE / NCERT (India)'
              :                            'Montessori (Canadian school)';
...
${curriculum === 'montessori' ? '- Pick ONE specific topic from the curriculum topic list above and test that exact topic. Rotate across topics over many questions so the student is exposed to the full scope.' : ''}`;
}
...
function buildLessonPrompt({ subject, curriculum, question, choices, correctIndex, userIndex, concept }) {
  ...
  const board = curriculum === 'ontario' ? 'Ontario'
